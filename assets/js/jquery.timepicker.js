      ...
      [
        ...
        },
        {
          ...
          value: function _hideKeyboard() {
            return (
              (window.navigator.msMaxTouchPoints || 'ontouchstart' in document) && this.settings.disableTouchKeyboard
            )
          },
        },
        {
    ...
    var methods = {
      ...
      show: function show(e) {
        ...
        if (verticalOrientation == 't') {
          ...
          listOffset.top =
            self.offset().top - list.outerHeight() + parseInt(list.css('marginTop').replace('px', ''), 10)
        } else {
          // put it under the input
          list.removeClass('ui-timepicker-positioned-top')
          listOffset.top =
            self.offset().top + self.outerHeight() + parseInt(list.css('marginTop').replace('px', ''), 10)
        }
