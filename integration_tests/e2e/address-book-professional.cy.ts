...
context('Professional contacts', () => {
  it('Professional contacts page is rendered', () => {
    ...
    page.assertAnchorElementAtIndexWithin('dl', 0, 0, '/case/X000001/handoff/delius')
    page.assertAnchorElementAtIndexWithin('dl', 0, 1, '/case/X000001/handoff/delius')
    page.assertAnchorElementAtIndexWithin('dl', 0, 2, '/case/X000001/handoff/delius')
    page.assertAnchorElementAtIndexWithin('dl', 0, 3, '/case/X000001/handoff/delius')
    page.assertAnchorElementAtIndexWithin('dl', 0, 4, '/case/X000001/handoff/delius')
    ...
    page.assertAnchorElementAtIndexWithin('dl', 1, 0, '/case/X000001/handoff/delius')
    page.assertAnchorElementAtIndexWithin('dl', 1, 1, '/case/X000001/handoff/delius')
    page.assertAnchorElementAtIndexWithin('dl', 1, 2, '/case/X000001/handoff/delius')
    ...
    page.assertAnchorElementAtIndexWithin('dl', 2, 0, '/case/X000001/handoff/delius')
    page.assertAnchorElementAtIndexWithin('dl', 2, 1, '/case/X000001/handoff/delius')
    page.assertAnchorElementAtIndexWithin('dl', 2, 2, '/case/X000001/handoff/delius')
  })
})
