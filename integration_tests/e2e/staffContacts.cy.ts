...
context('Staff contacts', () => {
  it('Staff contacts page is rendered', () => {
    ...
    page.assertPageElementAtIndexWithin('dl', 1, 'dd', 2, 'yrhreender.hanandra@moj.gov.uk')
    ...
    cy.get('h3').eq(2).should('contain.text', 'Peter Parker')
    page.assertPageElementAtIndexWithin('dl', 2, 'dt', 0, 'Phone number')
    page.assertPageElementAtIndexWithin('dl', 2, 'dd', 0, '07321165373')
    page.assertPageElementAtIndexWithin('dl', 2, 'dt', 1, 'Email')
    page.assertPageElementAtIndexWithin('dl', 2, 'dd', 1, 'peter.parker@moj.gov.uk')
    page.assertPageElementAtIndexWithin('dl', 2, 'dt', 2, 'Provider')
    page.assertPageElementAtIndexWithin('dl', 2, 'dd', 2, 'London')
    page.assertPageElementAtIndexWithin('dl', 2, 'dt', 3, 'Probation Delivery Unit (PDU)')
    page.assertPageElementAtIndexWithin('dl', 2, 'dd', 3, 'N07 Cluster 1')
    page.assertPageElementAtIndexWithin('dl', 2, 'dt', 4, 'Team')
    page.assertPageElementAtIndexWithin('dl', 2, 'dd', 4, 'OMU B')

    cy.get('h3').eq(3).should('contain.text', 'Bruce Wayne')
    page.assertPageElementAtIndexWithin('dl', 3, 'dt', 0, 'Provider')
    page.assertPageElementAtIndexWithin('dl', 3, 'dd', 0, 'Leicester')
    page.assertPageElementAtIndexWithin('dl', 3, 'dt', 1, 'Probation Delivery Unit (PDU)')
    page.assertPageElementAtIndexWithin('dl', 3, 'dd', 1, 'Leicestershire All')
    page.assertPageElementAtIndexWithin('dl', 3, 'dt', 2, 'Team')
    page.assertPageElementAtIndexWithin('dl', 3, 'dd', 2, 'OMU B')
    page.assertPageElementAtIndexWithin('dl', 3, 'dt', 3, 'Allocated until')
    page.assertPageElementAtIndexWithin('dl', 3, 'dd', 3, '30 April 2024')

    cy.get('h3').eq(4).should('contain.text', 'Jon Smith')
    page.assertPageElementAtIndexWithin('dl', 4, 'dt', 0, 'Provider')
    page.assertPageElementAtIndexWithin('dl', 4, 'dd', 0, 'Public Protection Unit')
    page.assertPageElementAtIndexWithin('dl', 4, 'dt', 1, 'Probation Delivery Unit (PDU)')
    page.assertPageElementAtIndexWithin('dl', 4, 'dd', 1, 'Bradford')
    page.assertPageElementAtIndexWithin('dl', 4, 'dt', 2, 'Team')
    page.assertPageElementAtIndexWithin('dl', 4, 'dd', 2, 'CPA West Yorkshire')
    page.assertPageElementAtIndexWithin('dl', 4, 'dt', 3, 'Allocated until')
    page.assertPageElementAtIndexWithin('dl', 4, 'dd', 3, '30 January 2025')
  })
})
